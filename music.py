...
#4봇 음악 세팅하기--------------------------------------------------------------------------------------------------------------------------------------------------------------
#5 노래 출력 코드 짜기--------------------------------------------------------------------------------------------------------------------------------------------------------------
#6. URL없이 검색만으로 음악 재생하기--------------------------------------------------------------------------------------------------------------------------------------------------------------
#7. 노래 일시정지, 다시 재생 코드 만들기 --------------------------------------------------------------------------------------------------------------------------------------------------------------
#8. 다양한 명령어와 봇 코드 다듬기-----------------------------------------------------------------------------------------------------------------------------------------------------
#9. 대기열과 목록 명령어 만들기
#10. 유저별 즐겨찾기 명령어 만들기
#11-1. 도움말 명령어와 봇 자동참가 & 자동퇴장 코드만들기
#11-2. 재생 명령어 노래가 있다면 대기열로 자동추가 코드 만들기
 #12-1. 뮤직봇 24시간 서버 설정하기
...
async def 나가(ctx):
    try:
        ...
        await ctx.semd("이미 그 채널에 속해있지 않아요")
